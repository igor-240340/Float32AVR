...
GETINT:     PUSH A3                     ; Backup NUM=|NUM|.
            ...
            ; Таким образом, двоичная экспонента после извлечения целой части лежит в [-1,-23] или [126,104].
            ; А после умножения на 10 экспонента лежит в [3,-20] или [130,107] в коде со смещением.
